// Wait for first paint to complete before running ANY code
// This prevents forced reflows during initial render (causes purple flash in Chrome)
...
(function() {
  ...
  // Hero ready state removed - page fade handles it
  ...
  // ── Smooth Scroll ──
  // Delayed start - wait for first paint to avoid flash
  (function() {
    ...
    // Only start the loop after first user scroll, not on page load
  ...
  // ── Custom Cursor ──
  // Only starts on first mousemove, not on page load
